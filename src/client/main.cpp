        ...
        case 1: //login业务
        {
           ...
           // g_isLoginSuccess = false;
            ...
            else
            {
                ...
                if(-1==len)
                {
                    cerr<<"recv server login response error "<<endl;
                    exit(-1);
                }
                else
                {
        ...
        //给服务器发送注册json
            ...
            {   //接收服务器的应答注册json
                ...
                if(-1==len)
                {
                    ...
                    {
                        cerr<<string(name)<<" is already exist , register error !"<<endl;
                    }
                    else
                    {
                        cout<<string(name)<<" register success, userid is"<< responsejs["id"]
